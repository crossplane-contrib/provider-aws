...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.TargetGroup) (managed.TypedExternalClient[*svcapitypes.TargetGroup], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.TargetGroup) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.TargetGroup) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.TargetGroup) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.TargetGroup) (managed.ExternalDelete, error) {
...
type external struct {
	...
	postDelete     func(context.Context, *svcapitypes.TargetGroup, *svcsdk.DeleteTargetGroupOutput, error) (managed.ExternalDelete, error)
...
func nopPostDelete(_ context.Context, _ *svcapitypes.TargetGroup, _ *svcsdk.DeleteTargetGroupOutput, err error) (managed.ExternalDelete, error) {
