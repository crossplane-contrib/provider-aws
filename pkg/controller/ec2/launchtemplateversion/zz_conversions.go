		...
		if elem.LaunchTemplateData != nil {
			...
			if elem.LaunchTemplateData.InstanceRequirements != nil {
				...
				if elem.LaunchTemplateData.InstanceRequirements.MaxSpotPriceAsPercentageOfOptimalOnDemandPrice != nil {
					f3f15.MaxSpotPriceAsPercentageOfOptimalOnDemandPrice = elem.LaunchTemplateData.InstanceRequirements.MaxSpotPriceAsPercentageOfOptimalOnDemandPrice
				}
				if elem.LaunchTemplateData.InstanceRequirements.MemoryGiBPerVCpu != nil {
					f3f15f15 := &svcapitypes.MemoryGiBPerVCPURequest{}
					if elem.LaunchTemplateData.InstanceRequirements.MemoryGiBPerVCpu.Max != nil {
						f3f15f15.Max = elem.LaunchTemplateData.InstanceRequirements.MemoryGiBPerVCpu.Max
					}
					if elem.LaunchTemplateData.InstanceRequirements.MemoryGiBPerVCpu.Min != nil {
						f3f15f15.Min = elem.LaunchTemplateData.InstanceRequirements.MemoryGiBPerVCpu.Min
					}
					f3f15.MemoryGiBPerVCPU = f3f15f15
				}
				if elem.LaunchTemplateData.InstanceRequirements.MemoryMiB != nil {
					f3f15f16 := &svcapitypes.MemoryMiBRequest{}
					if elem.LaunchTemplateData.InstanceRequirements.MemoryMiB.Max != nil {
						f3f15f16.Max = elem.LaunchTemplateData.InstanceRequirements.MemoryMiB.Max
					}
					if elem.LaunchTemplateData.InstanceRequirements.MemoryMiB.Min != nil {
						f3f15f16.Min = elem.LaunchTemplateData.InstanceRequirements.MemoryMiB.Min
					}
					f3f15.MemoryMiB = f3f15f16
				}
				if elem.LaunchTemplateData.InstanceRequirements.NetworkBandwidthGbps != nil {
					f3f15f17 := &svcapitypes.NetworkBandwidthGbpsRequest{}
					if elem.LaunchTemplateData.InstanceRequirements.NetworkBandwidthGbps.Max != nil {
						f3f15f17.Max = elem.LaunchTemplateData.InstanceRequirements.NetworkBandwidthGbps.Max
					}
					if elem.LaunchTemplateData.InstanceRequirements.NetworkBandwidthGbps.Min != nil {
						f3f15f17.Min = elem.LaunchTemplateData.InstanceRequirements.NetworkBandwidthGbps.Min
					}
					f3f15.NetworkBandwidthGbps = f3f15f17
				}
				if elem.LaunchTemplateData.InstanceRequirements.NetworkInterfaceCount != nil {
					f3f15f18 := &svcapitypes.NetworkInterfaceCountRequest{}
					if elem.LaunchTemplateData.InstanceRequirements.NetworkInterfaceCount.Max != nil {
						f3f15f18.Max = elem.LaunchTemplateData.InstanceRequirements.NetworkInterfaceCount.Max
					}
					if elem.LaunchTemplateData.InstanceRequirements.NetworkInterfaceCount.Min != nil {
						f3f15f18.Min = elem.LaunchTemplateData.InstanceRequirements.NetworkInterfaceCount.Min
					}
					f3f15.NetworkInterfaceCount = f3f15f18
				}
				...
				if elem.LaunchTemplateData.InstanceRequirements.TotalLocalStorageGB != nil {
					f3f15f22 := &svcapitypes.TotalLocalStorageGBRequest{}
					if elem.LaunchTemplateData.InstanceRequirements.TotalLocalStorageGB.Max != nil {
						f3f15f22.Max = elem.LaunchTemplateData.InstanceRequirements.TotalLocalStorageGB.Max
					}
					if elem.LaunchTemplateData.InstanceRequirements.TotalLocalStorageGB.Min != nil {
						f3f15f22.Min = elem.LaunchTemplateData.InstanceRequirements.TotalLocalStorageGB.Min
					}
					f3f15.TotalLocalStorageGB = f3f15f22
				}
				if elem.LaunchTemplateData.InstanceRequirements.VCpuCount != nil {
					f3f15f23 := &svcapitypes.VCPUCountRangeRequest{}
					if elem.LaunchTemplateData.InstanceRequirements.VCpuCount.Max != nil {
						f3f15f23.Max = elem.LaunchTemplateData.InstanceRequirements.VCpuCount.Max
					}
					if elem.LaunchTemplateData.InstanceRequirements.VCpuCount.Min != nil {
						f3f15f23.Min = elem.LaunchTemplateData.InstanceRequirements.VCpuCount.Min
					}
					f3f15.VCPUCount = f3f15f23
				}
...
func GenerateCreateLaunchTemplateVersionInput(cr *svcapitypes.LaunchTemplateVersion) *svcsdk.CreateLaunchTemplateVersionInput {
	...
	if cr.Spec.ForProvider.LaunchTemplateData != nil {
		...
		if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements != nil {
			...
			if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.MaxSpotPriceAsPercentageOfOptimalOnDemandPrice != nil {
				f0f15.SetMaxSpotPriceAsPercentageOfOptimalOnDemandPrice(*cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.MaxSpotPriceAsPercentageOfOptimalOnDemandPrice)
			}
			if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.MemoryGiBPerVCPU != nil {
				f0f15f15 := &svcsdk.MemoryGiBPerVCpuRequest{}
				if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.MemoryGiBPerVCPU.Max != nil {
					f0f15f15.SetMax(*cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.MemoryGiBPerVCPU.Max)
				}
				if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.MemoryGiBPerVCPU.Min != nil {
					f0f15f15.SetMin(*cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.MemoryGiBPerVCPU.Min)
				}
				f0f15.SetMemoryGiBPerVCpu(f0f15f15)
			}
			if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.MemoryMiB != nil {
				f0f15f16 := &svcsdk.MemoryMiBRequest{}
				if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.MemoryMiB.Max != nil {
					f0f15f16.SetMax(*cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.MemoryMiB.Max)
				}
				if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.MemoryMiB.Min != nil {
					f0f15f16.SetMin(*cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.MemoryMiB.Min)
				}
				f0f15.SetMemoryMiB(f0f15f16)
			}
			if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.NetworkBandwidthGbps != nil {
				f0f15f17 := &svcsdk.NetworkBandwidthGbpsRequest{}
				if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.NetworkBandwidthGbps.Max != nil {
					f0f15f17.SetMax(*cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.NetworkBandwidthGbps.Max)
				}
				if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.NetworkBandwidthGbps.Min != nil {
					f0f15f17.SetMin(*cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.NetworkBandwidthGbps.Min)
				}
				f0f15.SetNetworkBandwidthGbps(f0f15f17)
			}
			if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.NetworkInterfaceCount != nil {
				f0f15f18 := &svcsdk.NetworkInterfaceCountRequest{}
				if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.NetworkInterfaceCount.Max != nil {
					f0f15f18.SetMax(*cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.NetworkInterfaceCount.Max)
				}
				if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.NetworkInterfaceCount.Min != nil {
					f0f15f18.SetMin(*cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.NetworkInterfaceCount.Min)
				}
				f0f15.SetNetworkInterfaceCount(f0f15f18)
			}
			...
			if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.TotalLocalStorageGB != nil {
				f0f15f22 := &svcsdk.TotalLocalStorageGBRequest{}
				if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.TotalLocalStorageGB.Max != nil {
					f0f15f22.SetMax(*cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.TotalLocalStorageGB.Max)
				}
				if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.TotalLocalStorageGB.Min != nil {
					f0f15f22.SetMin(*cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.TotalLocalStorageGB.Min)
				}
				f0f15.SetTotalLocalStorageGB(f0f15f22)
			}
			if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.VCPUCount != nil {
				f0f15f23 := &svcsdk.VCpuCountRangeRequest{}
				if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.VCPUCount.Max != nil {
					f0f15f23.SetMax(*cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.VCPUCount.Max)
				}
				if cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.VCPUCount.Min != nil {
					f0f15f23.SetMin(*cr.Spec.ForProvider.LaunchTemplateData.InstanceRequirements.VCPUCount.Min)
				}
				f0f15.SetVCpuCount(f0f15f23)
			}
