...
const (
	errUnexpectedObject = "managed resource is not an LifecyclePolicy resource"

	errCreateSession = "cannot create a new session"
	errCreate        = "cannot create LifecyclePolicy in AWS"
	errUpdate        = "cannot update LifecyclePolicy in AWS"
	errDescribe      = "failed to describe LifecyclePolicy"
	errDelete        = "failed to delete LifecyclePolicy"
)
...
func (e *external) Observe(ctx context.Context, mg cpresource.Managed) (managed.ExternalObservation, error) {
	...
	input := GenerateGetLifecyclePolicyInput(cr)
...
func newExternal(kube client.Client, client svcsdkapi.ECRAPI, opts []option) *external {
	e := &external{
		kube:           kube,
		client:         client,
...
func nopPostObserve(_ context.Context, _ *svcapitypes.LifecyclePolicy, _ *svcsdk.GetLifecyclePolicyOutput, obs managed.ExternalObservation, err error) (managed.ExternalObservation, error) {
	return obs, err
}
...
func nopPostCreate(_ context.Context, _ *svcapitypes.LifecyclePolicy, _ *svcsdk.PutLifecyclePolicyOutput, cre managed.ExternalCreation, err error) (managed.ExternalCreation, error) {
	return cre, err
}
