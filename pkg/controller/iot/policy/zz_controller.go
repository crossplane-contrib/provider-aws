...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.Policy) (managed.TypedExternalClient[*svcapitypes.Policy], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.Policy) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.Policy) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.Policy) (managed.ExternalUpdate, error) {
	return e.update(ctx, cr)

}

func (e *external) Delete(ctx context.Context, cr *svcapitypes.Policy) (managed.ExternalDelete, error) {
...
type external struct {
	...
	update         func(context.Context, *svcapitypes.Policy) (managed.ExternalUpdate, error)
}
...
func nopUpdate(context.Context, *svcapitypes.Policy) (managed.ExternalUpdate, error) {
