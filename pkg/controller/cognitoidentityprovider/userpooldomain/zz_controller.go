...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.UserPoolDomain) (managed.TypedExternalClient[*svcapitypes.UserPoolDomain], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.UserPoolDomain) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.UserPoolDomain) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.UserPoolDomain) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.UserPoolDomain) (managed.ExternalDelete, error) {
