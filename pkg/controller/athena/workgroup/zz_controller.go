...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.WorkGroup) (managed.TypedExternalClient[*svcapitypes.WorkGroup], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.WorkGroup) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.WorkGroup) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.WorkGroup) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.WorkGroup) (managed.ExternalDelete, error) {
...
type external struct {
	...
	postDelete     func(context.Context, *svcapitypes.WorkGroup, *svcsdk.DeleteWorkGroupOutput, error) (managed.ExternalDelete, error)
...
func nopPostDelete(_ context.Context, _ *svcapitypes.WorkGroup, _ *svcsdk.DeleteWorkGroupOutput, err error) (managed.ExternalDelete, error) {
