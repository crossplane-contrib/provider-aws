...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.CloudFrontOriginAccessIdentity) (managed.TypedExternalClient[*svcapitypes.CloudFrontOriginAccessIdentity], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.CloudFrontOriginAccessIdentity) (managed.ExternalObservation, error) {
	if meta.GetExternalName(cr) == "" {
		return managed.ExternalObservation{
			ResourceExists: false,
		}, nil
	}
	input := GenerateGetCloudFrontOriginAccessIdentityInput(cr)
	if err := e.preObserve(ctx, cr, input); err != nil {
		return managed.ExternalObservation{}, errors.Wrap(err, "pre-observe failed")
	}
	resp, err := e.client.GetCloudFrontOriginAccessIdentityWithContext(ctx, input)
	if err != nil {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.CloudFrontOriginAccessIdentity) (managed.ExternalCreation, error) {
	cr.Status.SetConditions(xpv1.Creating())
	input := GenerateCreateCloudFrontOriginAccessIdentityInput(cr)
	if err := e.preCreate(ctx, cr, input); err != nil {
		return managed.ExternalCreation{}, errors.Wrap(err, "pre-create failed")
	}
	resp, err := e.client.CreateCloudFrontOriginAccessIdentityWithContext(ctx, input)
	if err != nil {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.CloudFrontOriginAccessIdentity) (managed.ExternalUpdate, error) {
	input := GenerateUpdateCloudFrontOriginAccessIdentityInput(cr)
	if err := e.preUpdate(ctx, cr, input); err != nil {
		return managed.ExternalUpdate{}, errors.Wrap(err, "pre-update failed")
	}
	resp, err := e.client.UpdateCloudFrontOriginAccessIdentityWithContext(ctx, input)
	return e.postUpdate(ctx, cr, resp, managed.ExternalUpdate{}, errorutils.Wrap(err, errUpdate))
}

func (e *external) Delete(ctx context.Context, cr *svcapitypes.CloudFrontOriginAccessIdentity) (managed.ExternalDelete, error) {
