...
func (e *hooks) update(ctx context.Context, cr *svcapitypes.ConfigurationSet) (managed.ExternalUpdate, error) { //nolint:gocyclo
	...
	configurationSetName := pointer.ToOrNilIfZeroValue(cr.GetAnnotations()[meta.AnnotationKeyExternalName])
