...
func GenerateCreateDomainInput(cr *svcapitypes.Domain) *svcsdk.CreateDomainInput {
	...
	if cr.Spec.ForProvider.EncryptionAtRestOptions != nil {
		f8 := &svcsdk.EncryptionAtRestOptions{}
		if cr.Spec.ForProvider.EncryptionAtRestOptions.Enabled != nil {
			f8.SetEnabled(*cr.Spec.ForProvider.EncryptionAtRestOptions.Enabled)
		}
		if cr.Spec.ForProvider.EncryptionAtRestOptions.KMSKeyID != nil {
			f8.SetKmsKeyId(*cr.Spec.ForProvider.EncryptionAtRestOptions.KMSKeyID)
		}
		res.SetEncryptionAtRestOptions(f8)
	}
	...
	if cr.Spec.ForProvider.TagList != nil {
		f13 := []*svcsdk.Tag{}
		for _, f13iter := range cr.Spec.ForProvider.TagList {
			f13elem := &svcsdk.Tag{}
			if f13iter.Key != nil {
