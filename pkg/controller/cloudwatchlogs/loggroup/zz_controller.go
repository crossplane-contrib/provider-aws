...
const (
	errUnexpectedObject = "managed resource is not an LogGroup resource"

	errCreateSession = "cannot create a new session"
	errCreate        = "cannot create LogGroup in AWS"
	errUpdate        = "cannot update LogGroup in AWS"
	errDescribe      = "failed to describe LogGroup"
	errDelete        = "failed to delete LogGroup"
)
...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.LogGroup) (managed.TypedExternalClient[*svcapitypes.LogGroup], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.LogGroup) (managed.ExternalObservation, error) {
	if meta.GetExternalName(cr) == "" {
		return managed.ExternalObservation{
			ResourceExists: false,
		}, nil
	}
	input := GenerateDescribeLogGroupsInput(cr)
	if err := e.preObserve(ctx, cr, input); err != nil {
		return managed.ExternalObservation{}, errors.Wrap(err, "pre-observe failed")
	}
	resp, err := e.client.DescribeLogGroupsWithContext(ctx, input)
	if err != nil {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.LogGroup) (managed.ExternalCreation, error) {
	cr.Status.SetConditions(xpv1.Creating())
	input := GenerateCreateLogGroupInput(cr)
	if err := e.preCreate(ctx, cr, input); err != nil {
		return managed.ExternalCreation{}, errors.Wrap(err, "pre-create failed")
	}
	resp, err := e.client.CreateLogGroupWithContext(ctx, input)
	if err != nil {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.LogGroup) (managed.ExternalUpdate, error) {
	return e.update(ctx, cr)

}

func (e *external) Delete(ctx context.Context, cr *svcapitypes.LogGroup) (managed.ExternalDelete, error) {
...
type external struct {
	...
	preObserve     func(context.Context, *svcapitypes.LogGroup, *svcsdk.DescribeLogGroupsInput) error
	...
	update         func(context.Context, *svcapitypes.LogGroup) (managed.ExternalUpdate, error)
}

func nopPreObserve(context.Context, *svcapitypes.LogGroup, *svcsdk.DescribeLogGroupsInput) error {
	return nil
}
func nopPostObserve(_ context.Context, _ *svcapitypes.LogGroup, _ *svcsdk.DescribeLogGroupsOutput, obs managed.ExternalObservation, err error) (managed.ExternalObservation, error) {
	return obs, err
}
func nopFilterList(_ *svcapitypes.LogGroup, list *svcsdk.DescribeLogGroupsOutput) *svcsdk.DescribeLogGroupsOutput {
	return list
}
...
func nopPostCreate(_ context.Context, _ *svcapitypes.LogGroup, _ *svcsdk.CreateLogGroupOutput, cre managed.ExternalCreation, err error) (managed.ExternalCreation, error) {
	return cre, err
}
...
func nopUpdate(context.Context, *svcapitypes.LogGroup) (managed.ExternalUpdate, error) {
