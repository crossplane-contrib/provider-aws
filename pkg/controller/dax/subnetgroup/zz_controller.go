...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.SubnetGroup) (managed.TypedExternalClient[*svcapitypes.SubnetGroup], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.SubnetGroup) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.SubnetGroup) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.SubnetGroup) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.SubnetGroup) (managed.ExternalDelete, error) {
...
type external struct {
	...
	postDelete     func(context.Context, *svcapitypes.SubnetGroup, *svcsdk.DeleteSubnetGroupOutput, error) (managed.ExternalDelete, error)
...
func nopPostDelete(_ context.Context, _ *svcapitypes.SubnetGroup, _ *svcsdk.DeleteSubnetGroupOutput, err error) (managed.ExternalDelete, error) {
