...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.WebACL) (managed.TypedExternalClient[*svcapitypes.WebACL], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.WebACL) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.WebACL) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.WebACL) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.WebACL) (managed.ExternalDelete, error) {
...
type external struct {
	...
	postDelete     func(context.Context, *svcapitypes.WebACL, *svcsdk.DeleteWebACLOutput, error) (managed.ExternalDelete, error)
...
func nopPostDelete(_ context.Context, _ *svcapitypes.WebACL, _ *svcsdk.DeleteWebACLOutput, err error) (managed.ExternalDelete, error) {
