...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.DBSubnetGroup) (managed.TypedExternalClient[*svcapitypes.DBSubnetGroup], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.DBSubnetGroup) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.DBSubnetGroup) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.DBSubnetGroup) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.DBSubnetGroup) (managed.ExternalDelete, error) {
