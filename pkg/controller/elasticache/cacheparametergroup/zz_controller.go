...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.CacheParameterGroup) (managed.TypedExternalClient[*svcapitypes.CacheParameterGroup], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.CacheParameterGroup) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.CacheParameterGroup) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.CacheParameterGroup) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.CacheParameterGroup) (managed.ExternalDelete, error) {
