...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.FunctionURLConfig) (managed.TypedExternalClient[*svcapitypes.FunctionURLConfig], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.FunctionURLConfig) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.FunctionURLConfig) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.FunctionURLConfig) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.FunctionURLConfig) (managed.ExternalDelete, error) {
...
type external struct {
	...
	postDelete     func(context.Context, *svcapitypes.FunctionURLConfig, *svcsdk.DeleteFunctionUrlConfigOutput, error) (managed.ExternalDelete, error)
...
func nopPostDelete(_ context.Context, _ *svcapitypes.FunctionURLConfig, _ *svcsdk.DeleteFunctionUrlConfigOutput, err error) (managed.ExternalDelete, error) {
