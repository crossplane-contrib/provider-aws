...
func (e *external) Delete(ctx context.Context, mg cpresource.Managed) error {
	...
	_, err := e.client.DeleteFunctionWithContext(ctx, input)
...
type external struct {
	...
	isUpToDate     func(*svcapitypes.Function, *svcsdk.GetFunctionOutput) bool
	...
	preDelete      func(context.Context, *svcapitypes.Function, *svcsdk.DeleteFunctionInput) error
...
func nopPostObserve(context.Context, *svcapitypes.Function, *svcsdk.GetFunctionOutput, managed.ExternalObservation, error) (managed.ExternalObservation, error) {
	return managed.ExternalObservation{}, nil
}
func nopLateInitialize(*svcapitypes.FunctionParameters, *svcsdk.GetFunctionOutput) error {
	return nil
}
func alwaysUpToDate(*svcapitypes.Function, *svcsdk.GetFunctionOutput) bool {
	return true
}
...
func nopPostCreate(context.Context, *svcapitypes.Function, *svcsdk.FunctionConfiguration, managed.ExternalCreation, error) (managed.ExternalCreation, error) {
	return managed.ExternalCreation{}, nil
}
func nopPreDelete(context.Context, *svcapitypes.Function, *svcsdk.DeleteFunctionInput) error {
	return nil
}
