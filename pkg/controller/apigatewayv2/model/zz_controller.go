...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.Model) (managed.TypedExternalClient[*svcapitypes.Model], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.Model) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.Model) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.Model) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.Model) (managed.ExternalDelete, error) {
