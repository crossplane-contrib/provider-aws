...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.RouteResponse) (managed.TypedExternalClient[*svcapitypes.RouteResponse], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.RouteResponse) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.RouteResponse) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.RouteResponse) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.RouteResponse) (managed.ExternalDelete, error) {
...
type external struct {
	...
	postDelete     func(context.Context, *svcapitypes.RouteResponse, *svcsdk.DeleteRouteResponseOutput, error) (managed.ExternalDelete, error)
...
func nopPostDelete(_ context.Context, _ *svcapitypes.RouteResponse, _ *svcsdk.DeleteRouteResponseOutput, err error) (managed.ExternalDelete, error) {
