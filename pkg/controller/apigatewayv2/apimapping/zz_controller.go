...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.APIMapping) (managed.TypedExternalClient[*svcapitypes.APIMapping], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.APIMapping) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.APIMapping) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.APIMapping) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.APIMapping) (managed.ExternalDelete, error) {
