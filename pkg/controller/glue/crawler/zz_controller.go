...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.Crawler) (managed.TypedExternalClient[*svcapitypes.Crawler], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.Crawler) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.Crawler) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.Crawler) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.Crawler) (managed.ExternalDelete, error) {
...
type external struct {
	...
	postDelete     func(context.Context, *svcapitypes.Crawler, *svcsdk.DeleteCrawlerOutput, error) (managed.ExternalDelete, error)
...
func nopPostDelete(_ context.Context, _ *svcapitypes.Crawler, _ *svcsdk.DeleteCrawlerOutput, err error) (managed.ExternalDelete, error) {
