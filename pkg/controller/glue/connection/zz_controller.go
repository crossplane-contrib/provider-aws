...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.Connection) (managed.TypedExternalClient[*svcapitypes.Connection], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.Connection) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.Connection) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.Connection) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.Connection) (managed.ExternalDelete, error) {
...
type external struct {
	...
	postDelete     func(context.Context, *svcapitypes.Connection, *svcsdk.DeleteConnectionOutput, error) (managed.ExternalDelete, error)
...
func nopPostDelete(_ context.Context, _ *svcapitypes.Connection, _ *svcsdk.DeleteConnectionOutput, err error) (managed.ExternalDelete, error) {
