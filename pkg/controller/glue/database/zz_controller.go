...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.Database) (managed.TypedExternalClient[*svcapitypes.Database], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.Database) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.Database) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.Database) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.Database) (managed.ExternalDelete, error) {
...
type external struct {
	...
	postDelete     func(context.Context, *svcapitypes.Database, *svcsdk.DeleteDatabaseOutput, error) (managed.ExternalDelete, error)
...
func nopPostDelete(_ context.Context, _ *svcapitypes.Database, _ *svcsdk.DeleteDatabaseOutput, err error) (managed.ExternalDelete, error) {
