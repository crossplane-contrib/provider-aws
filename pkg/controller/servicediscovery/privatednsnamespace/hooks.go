...
func isUpToDate(cr *svcapitypes.PrivateDNSNamespace, resp *svcsdk.GetNamespaceOutput) bool {
...
func lateInitialize(forProvider *svcapitypes.PrivateDNSNamespaceParameters, nsReqResp *svcsdk.GetNamespaceOutput) {
	if nsReqResp == nil {
		return
	}
