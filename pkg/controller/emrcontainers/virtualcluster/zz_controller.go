...
const (
	errUnexpectedObject = "managed resource is not an VirtualCluster resource"

	errCreateSession = "cannot create a new session"
	errCreate        = "cannot create VirtualCluster in AWS"
	errUpdate        = "cannot update VirtualCluster in AWS"
	errDescribe      = "failed to describe VirtualCluster"
	errDelete        = "failed to delete VirtualCluster"
)
...
func (e *external) Observe(ctx context.Context, mg cpresource.Managed) (managed.ExternalObservation, error) {
	...
	input := GenerateDescribeVirtualClusterInput(cr)
	if err := e.preObserve(ctx, cr, input); err != nil {
		return managed.ExternalObservation{}, errors.Wrap(err, "pre-observe failed")
	}
	resp, err := e.client.DescribeVirtualClusterWithContext(ctx, input)
	if err != nil {
...
func (e *external) Create(ctx context.Context, mg cpresource.Managed) (managed.ExternalCreation, error) {
	...
	resp, err := e.client.CreateVirtualClusterWithContext(ctx, input)
	if err != nil {
...
func (e *external) Delete(ctx context.Context, mg cpresource.Managed) error {
	...
	resp, err := e.client.DeleteVirtualClusterWithContext(ctx, input)
...
type external struct {
	...
	postDelete     func(context.Context, *svcapitypes.VirtualCluster, *svcsdk.DeleteVirtualClusterOutput, error) error
...
func nopPostObserve(_ context.Context, _ *svcapitypes.VirtualCluster, _ *svcsdk.DescribeVirtualClusterOutput, obs managed.ExternalObservation, err error) (managed.ExternalObservation, error) {
	return obs, err
}
...
func nopPostCreate(_ context.Context, _ *svcapitypes.VirtualCluster, _ *svcsdk.CreateVirtualClusterOutput, cre managed.ExternalCreation, err error) (managed.ExternalCreation, error) {
	return cre, err
}
func nopPreDelete(context.Context, *svcapitypes.VirtualCluster, *svcsdk.DeleteVirtualClusterInput) (bool, error) {
	return false, nil
}
func nopPostDelete(_ context.Context, _ *svcapitypes.VirtualCluster, _ *svcsdk.DeleteVirtualClusterOutput, err error) error {
	return err
}
