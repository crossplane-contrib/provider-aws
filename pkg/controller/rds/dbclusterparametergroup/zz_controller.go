...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.DBClusterParameterGroup) (managed.TypedExternalClient[*svcapitypes.DBClusterParameterGroup], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.DBClusterParameterGroup) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.DBClusterParameterGroup) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.DBClusterParameterGroup) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.DBClusterParameterGroup) (managed.ExternalDelete, error) {
...
type external struct {
	...
	postDelete     func(context.Context, *svcapitypes.DBClusterParameterGroup, *svcsdk.DeleteDBClusterParameterGroupOutput, error) (managed.ExternalDelete, error)
	preUpdate      func(context.Context, *svcapitypes.DBClusterParameterGroup, *svcsdk.ModifyDBClusterParameterGroupInput) error
	postUpdate     func(context.Context, *svcapitypes.DBClusterParameterGroup, *svcsdk.DBClusterParameterGroupNameMessage, managed.ExternalUpdate, error) (managed.ExternalUpdate, error)
}
...
func nopPostDelete(_ context.Context, _ *svcapitypes.DBClusterParameterGroup, _ *svcsdk.DeleteDBClusterParameterGroupOutput, err error) (managed.ExternalDelete, error) {
...
func nopPostUpdate(_ context.Context, _ *svcapitypes.DBClusterParameterGroup, _ *svcsdk.DBClusterParameterGroupNameMessage, upd managed.ExternalUpdate, err error) (managed.ExternalUpdate, error) {
	return upd, err
}
