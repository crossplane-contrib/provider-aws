...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.Server) (managed.TypedExternalClient[*svcapitypes.Server], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.Server) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.Server) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.Server) (managed.ExternalUpdate, error) {
	return e.update(ctx, cr)

}

func (e *external) Delete(ctx context.Context, cr *svcapitypes.Server) (managed.ExternalDelete, error) {
...
type external struct {
	...
	postDelete     func(context.Context, *svcapitypes.Server, *svcsdk.DeleteServerOutput, error) (managed.ExternalDelete, error)
	update         func(context.Context, *svcapitypes.Server) (managed.ExternalUpdate, error)
}
...
func nopPostDelete(_ context.Context, _ *svcapitypes.Server, _ *svcsdk.DeleteServerOutput, err error) (managed.ExternalDelete, error) {
	return managed.ExternalDelete{}, err
}
func nopUpdate(context.Context, *svcapitypes.Server) (managed.ExternalUpdate, error) {
