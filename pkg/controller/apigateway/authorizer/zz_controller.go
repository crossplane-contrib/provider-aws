...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.Authorizer) (managed.TypedExternalClient[*svcapitypes.Authorizer], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.Authorizer) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.Authorizer) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.Authorizer) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.Authorizer) (managed.ExternalDelete, error) {
...
type external struct {
	...
	postDelete     func(context.Context, *svcapitypes.Authorizer, *svcsdk.DeleteAuthorizerOutput, error) (managed.ExternalDelete, error)
	preUpdate      func(context.Context, *svcapitypes.Authorizer, *svcsdk.UpdateAuthorizerInput) error
	postUpdate     func(context.Context, *svcapitypes.Authorizer, *svcsdk.Authorizer, managed.ExternalUpdate, error) (managed.ExternalUpdate, error)
}
...
func nopPostObserve(_ context.Context, _ *svcapitypes.Authorizer, _ *svcsdk.Authorizer, obs managed.ExternalObservation, err error) (managed.ExternalObservation, error) {
	return obs, err
}
...
func nopPostCreate(_ context.Context, _ *svcapitypes.Authorizer, _ *svcsdk.Authorizer, cre managed.ExternalCreation, err error) (managed.ExternalCreation, error) {
	return cre, err
}
func nopPreDelete(context.Context, *svcapitypes.Authorizer, *svcsdk.DeleteAuthorizerInput) (bool, error) {
	return false, nil
}
func nopPostDelete(_ context.Context, _ *svcapitypes.Authorizer, _ *svcsdk.DeleteAuthorizerOutput, err error) (managed.ExternalDelete, error) {
	return managed.ExternalDelete{}, err
}
func nopPreUpdate(context.Context, *svcapitypes.Authorizer, *svcsdk.UpdateAuthorizerInput) error {
	return nil
}
func nopPostUpdate(_ context.Context, _ *svcapitypes.Authorizer, _ *svcsdk.Authorizer, upd managed.ExternalUpdate, err error) (managed.ExternalUpdate, error) {
	return upd, err
}
