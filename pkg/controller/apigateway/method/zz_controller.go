...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.Method) (managed.TypedExternalClient[*svcapitypes.Method], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.Method) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.Method) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.Method) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.Method) (managed.ExternalDelete, error) {
...
type external struct {
	...
	postDelete     func(context.Context, *svcapitypes.Method, *svcsdk.DeleteMethodOutput, error) (managed.ExternalDelete, error)
...
func nopPostDelete(_ context.Context, _ *svcapitypes.Method, _ *svcsdk.DeleteMethodOutput, err error) (managed.ExternalDelete, error) {
