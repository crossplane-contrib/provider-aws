...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.VPCLink) (managed.TypedExternalClient[*svcapitypes.VPCLink], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.VPCLink) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.VPCLink) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.VPCLink) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.VPCLink) (managed.ExternalDelete, error) {
...
type external struct {
	...
	postDelete     func(context.Context, *svcapitypes.VPCLink, *svcsdk.DeleteVpcLinkOutput, error) (managed.ExternalDelete, error)
...
func nopPostObserve(_ context.Context, _ *svcapitypes.VPCLink, _ *svcsdk.UpdateVpcLinkOutput, obs managed.ExternalObservation, err error) (managed.ExternalObservation, error) {
	return obs, err
}
...
func nopPostCreate(_ context.Context, _ *svcapitypes.VPCLink, _ *svcsdk.UpdateVpcLinkOutput, cre managed.ExternalCreation, err error) (managed.ExternalCreation, error) {
	return cre, err
}
func nopPreDelete(context.Context, *svcapitypes.VPCLink, *svcsdk.DeleteVpcLinkInput) (bool, error) {
	return false, nil
}
func nopPostDelete(_ context.Context, _ *svcapitypes.VPCLink, _ *svcsdk.DeleteVpcLinkOutput, err error) (managed.ExternalDelete, error) {
