...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.Resource) (managed.TypedExternalClient[*svcapitypes.Resource], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.Resource) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.Resource) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.Resource) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.Resource) (managed.ExternalDelete, error) {
...
type external struct {
	...
	postDelete     func(context.Context, *svcapitypes.Resource, *svcsdk.DeleteResourceOutput, error) (managed.ExternalDelete, error)
...
func nopPostDelete(_ context.Context, _ *svcapitypes.Resource, _ *svcsdk.DeleteResourceOutput, err error) (managed.ExternalDelete, error) {
