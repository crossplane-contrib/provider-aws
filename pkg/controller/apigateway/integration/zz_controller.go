...
func (e *external) Create(ctx context.Context, cr *svcapitypes.Integration) (managed.ExternalCreation, error) {
	...
	input := GeneratePutIntegrationInput(cr)
	if err := e.preCreate(ctx, cr, input); err != nil {
		return managed.ExternalCreation{}, errors.Wrap(err, "pre-create failed")
	}
	resp, err := e.client.PutIntegrationWithContext(ctx, input)
	if err != nil {
...
type external struct {
	...
	postUpdate     func(context.Context, *svcapitypes.Integration, *svcsdk.Integration, managed.ExternalUpdate, error) (managed.ExternalUpdate, error)
}
...
func nopPostObserve(_ context.Context, _ *svcapitypes.Integration, _ *svcsdk.Integration, obs managed.ExternalObservation, err error) (managed.ExternalObservation, error) {
	return obs, err
}
...
func nopPostCreate(_ context.Context, _ *svcapitypes.Integration, _ *svcsdk.Integration, cre managed.ExternalCreation, err error) (managed.ExternalCreation, error) {
	return cre, err
}
...
func nopPostUpdate(_ context.Context, _ *svcapitypes.Integration, _ *svcsdk.Integration, upd managed.ExternalUpdate, err error) (managed.ExternalUpdate, error) {
	return upd, err
}
