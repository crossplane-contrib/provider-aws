...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.AlertManagerDefinition) (managed.TypedExternalClient[*svcapitypes.AlertManagerDefinition], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.AlertManagerDefinition) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.AlertManagerDefinition) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.AlertManagerDefinition) (managed.ExternalUpdate, error) {
	return e.update(ctx, cr)

}

func (e *external) Delete(ctx context.Context, cr *svcapitypes.AlertManagerDefinition) (managed.ExternalDelete, error) {
...
type external struct {
	...
	update         func(context.Context, *svcapitypes.AlertManagerDefinition) (managed.ExternalUpdate, error)
}
...
func nopUpdate(context.Context, *svcapitypes.AlertManagerDefinition) (managed.ExternalUpdate, error) {
