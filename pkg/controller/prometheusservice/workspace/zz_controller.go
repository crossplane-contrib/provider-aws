...
const (
	errUnexpectedObject = "managed resource is not an Workspace resource"

	errCreateSession = "cannot create a new session"
	errCreate        = "cannot create Workspace in AWS"
	errUpdate        = "cannot update Workspace in AWS"
	errDescribe      = "failed to describe Workspace"
	errDelete        = "failed to delete Workspace"
)
...
func (e *external) Observe(ctx context.Context, mg cpresource.Managed) (managed.ExternalObservation, error) {
	...
	input := GenerateDescribeWorkspaceInput(cr)
	if err := e.preObserve(ctx, cr, input); err != nil {
		return managed.ExternalObservation{}, errors.Wrap(err, "pre-observe failed")
	}
	resp, err := e.client.DescribeWorkspaceWithContext(ctx, input)
	if err != nil {
...
func (e *external) Create(ctx context.Context, mg cpresource.Managed) (managed.ExternalCreation, error) {
	...
	resp, err := e.client.CreateWorkspaceWithContext(ctx, input)
	if err != nil {
	...
	if resp.WorkspaceId != nil {
		cr.Status.AtProvider.WorkspaceID = resp.WorkspaceId
	} else {
...
func nopPostObserve(_ context.Context, _ *svcapitypes.Workspace, _ *svcsdk.DescribeWorkspaceOutput, obs managed.ExternalObservation, err error) (managed.ExternalObservation, error) {
	return obs, err
}
...
func nopPostCreate(_ context.Context, _ *svcapitypes.Workspace, _ *svcsdk.CreateWorkspaceOutput, cre managed.ExternalCreation, err error) (managed.ExternalCreation, error) {
	return cre, err
}
