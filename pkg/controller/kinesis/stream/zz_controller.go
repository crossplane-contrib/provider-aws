...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.Stream) (managed.TypedExternalClient[*svcapitypes.Stream], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.Stream) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.Stream) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.Stream) (managed.ExternalUpdate, error) {
	return e.update(ctx, cr)

}

func (e *external) Delete(ctx context.Context, cr *svcapitypes.Stream) (managed.ExternalDelete, error) {
...
type external struct {
	...
	update         func(context.Context, *svcapitypes.Stream) (managed.ExternalUpdate, error)
}
...
func nopUpdate(context.Context, *svcapitypes.Stream) (managed.ExternalUpdate, error) {
