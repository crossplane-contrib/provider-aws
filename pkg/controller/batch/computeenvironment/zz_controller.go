...
func (c *connector) Connect(ctx context.Context, mg cpresource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*svcapitypes.ComputeEnvironment)
	if !ok {
...
type external struct {
	...
	postDelete     func(context.Context, *svcapitypes.ComputeEnvironment, *svcsdk.DeleteComputeEnvironmentOutput, error) error
...
func nopPostDelete(_ context.Context, _ *svcapitypes.ComputeEnvironment, _ *svcsdk.DeleteComputeEnvironmentOutput, err error) error {
	return err
}
