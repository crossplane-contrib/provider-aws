...
const (
	errUnexpectedObject = "managed resource is not an TransformJob resource"

	errCreateSession = "cannot create a new session"
	errCreate        = "cannot create TransformJob in AWS"
	errDescribe      = "failed to describe TransformJob"
	errDelete        = "failed to delete TransformJob"
)
...
func (c *connector) Connect(ctx context.Context, mg cpresource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*svcapitypes.TransformJob)
	if !ok {
...
func (e *external) Observe(ctx context.Context, mg cpresource.Managed) (managed.ExternalObservation, error) {
	...
	input := GenerateDescribeTransformJobInput(cr)
	resp, err := e.client.DescribeTransformJobWithContext(ctx, input)
	if err != nil {
	...
	GenerateTransformJob(resp).Status.AtProvider.DeepCopyInto(&cr.Status.AtProvider)
...
func (e *external) Create(ctx context.Context, mg cpresource.Managed) (managed.ExternalCreation, error) {
	...
	input := GenerateCreateTransformJobInput(cr)
	resp, err := e.client.CreateTransformJobWithContext(ctx, input)
	if err != nil {
