...
const (
	errUnexpectedObject = "managed resource is not an AutoMLJob resource"

	errCreateSession = "cannot create a new session"
	errCreate        = "cannot create AutoMLJob in AWS"
	errDescribe      = "failed to describe AutoMLJob"
	errDelete        = "failed to delete AutoMLJob"
)
...
func (c *connector) Connect(ctx context.Context, mg cpresource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*svcapitypes.AutoMLJob)
	if !ok {
...
func (e *external) Observe(ctx context.Context, mg cpresource.Managed) (managed.ExternalObservation, error) {
	...
	input := GenerateDescribeAutoMLJobInput(cr)
	resp, err := e.client.DescribeAutoMLJobWithContext(ctx, input)
	if err != nil {
	...
	GenerateAutoMLJob(resp).Status.AtProvider.DeepCopyInto(&cr.Status.AtProvider)
...
func (e *external) Create(ctx context.Context, mg cpresource.Managed) (managed.ExternalCreation, error) {
	...
	input := GenerateCreateAutoMLJobInput(cr)
	resp, err := e.client.CreateAutoMLJobWithContext(ctx, input)
	if err != nil {
