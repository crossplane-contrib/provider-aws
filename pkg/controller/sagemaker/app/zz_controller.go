...
const (
	errUnexpectedObject = "managed resource is not an App resource"

	errCreateSession = "cannot create a new session"
	errCreate        = "cannot create App in AWS"
	errDescribe      = "failed to describe App"
	errDelete        = "failed to delete App"
)
...
func (e *external) Observe(ctx context.Context, mg cpresource.Managed) (managed.ExternalObservation, error) {
	...
	input := GenerateDescribeAppInput(cr)
	resp, err := e.client.DescribeAppWithContext(ctx, input)
	if err != nil {
	...
	GenerateApp(resp).Status.AtProvider.DeepCopyInto(&cr.Status.AtProvider)
...
func (e *external) Create(ctx context.Context, mg cpresource.Managed) (managed.ExternalCreation, error) {
	...
	input := GenerateCreateAppInput(cr)
	resp, err := e.client.CreateAppWithContext(ctx, input)
	if err != nil {
...
func (e *external) Delete(ctx context.Context, mg cpresource.Managed) error {
	...
	input := GenerateDeleteAppInput(cr)
	_, err := e.client.DeleteAppWithContext(ctx, input)
