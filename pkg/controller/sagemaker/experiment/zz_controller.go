...
const (
	errUnexpectedObject = "managed resource is not an Experiment resource"

	errCreateSession = "cannot create a new session"
	errCreate        = "cannot create Experiment in AWS"
	errDescribe      = "failed to describe Experiment"
	errDelete        = "failed to delete Experiment"
)
...
func (c *connector) Connect(ctx context.Context, mg cpresource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*svcapitypes.Experiment)
	if !ok {
...
func (e *external) Observe(ctx context.Context, mg cpresource.Managed) (managed.ExternalObservation, error) {
	...
	input := GenerateDescribeExperimentInput(cr)
	resp, err := e.client.DescribeExperimentWithContext(ctx, input)
	if err != nil {
	...
	GenerateExperiment(resp).Status.AtProvider.DeepCopyInto(&cr.Status.AtProvider)
...
func (e *external) Create(ctx context.Context, mg cpresource.Managed) (managed.ExternalCreation, error) {
	...
	input := GenerateCreateExperimentInput(cr)
	resp, err := e.client.CreateExperimentWithContext(ctx, input)
	if err != nil {
...
func (e *external) Delete(ctx context.Context, mg cpresource.Managed) error {
	...
	input := GenerateDeleteExperimentInput(cr)
	_, err := e.client.DeleteExperimentWithContext(ctx, input)
