...
const (
	errUnexpectedObject = "managed resource is not an MonitoringSchedule resource"

	errCreateSession = "cannot create a new session"
	errCreate        = "cannot create MonitoringSchedule in AWS"
	errDescribe      = "failed to describe MonitoringSchedule"
	errDelete        = "failed to delete MonitoringSchedule"
)
...
func (c *connector) Connect(ctx context.Context, mg cpresource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*svcapitypes.MonitoringSchedule)
	if !ok {
...
func (e *external) Observe(ctx context.Context, mg cpresource.Managed) (managed.ExternalObservation, error) {
	...
	input := GenerateDescribeMonitoringScheduleInput(cr)
	resp, err := e.client.DescribeMonitoringScheduleWithContext(ctx, input)
	if err != nil {
	...
	GenerateMonitoringSchedule(resp).Status.AtProvider.DeepCopyInto(&cr.Status.AtProvider)
...
func (e *external) Create(ctx context.Context, mg cpresource.Managed) (managed.ExternalCreation, error) {
	...
	input := GenerateCreateMonitoringScheduleInput(cr)
	resp, err := e.client.CreateMonitoringScheduleWithContext(ctx, input)
	if err != nil {
...
func (e *external) Delete(ctx context.Context, mg cpresource.Managed) error {
	...
	input := GenerateDeleteMonitoringScheduleInput(cr)
	_, err := e.client.DeleteMonitoringScheduleWithContext(ctx, input)
