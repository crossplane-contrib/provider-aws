...
const (
	errUnexpectedObject = "managed resource is not an LabelingJob resource"

	errCreateSession = "cannot create a new session"
	errCreate        = "cannot create LabelingJob in AWS"
	errDescribe      = "failed to describe LabelingJob"
	errDelete        = "failed to delete LabelingJob"
)
...
func (c *connector) Connect(ctx context.Context, mg cpresource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*svcapitypes.LabelingJob)
	if !ok {
...
func (e *external) Observe(ctx context.Context, mg cpresource.Managed) (managed.ExternalObservation, error) {
	...
	input := GenerateDescribeLabelingJobInput(cr)
	resp, err := e.client.DescribeLabelingJobWithContext(ctx, input)
	if err != nil {
	...
	GenerateLabelingJob(resp).Status.AtProvider.DeepCopyInto(&cr.Status.AtProvider)
...
func (e *external) Create(ctx context.Context, mg cpresource.Managed) (managed.ExternalCreation, error) {
	...
	input := GenerateCreateLabelingJobInput(cr)
	resp, err := e.client.CreateLabelingJobWithContext(ctx, input)
	if err != nil {
