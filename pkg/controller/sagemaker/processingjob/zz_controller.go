...
const (
	errUnexpectedObject = "managed resource is not an ProcessingJob resource"

	errCreateSession = "cannot create a new session"
	errCreate        = "cannot create ProcessingJob in AWS"
	errDescribe      = "failed to describe ProcessingJob"
	errDelete        = "failed to delete ProcessingJob"
)
...
func (c *connector) Connect(ctx context.Context, mg cpresource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*svcapitypes.ProcessingJob)
	if !ok {
...
func (e *external) Observe(ctx context.Context, mg cpresource.Managed) (managed.ExternalObservation, error) {
	...
	input := GenerateDescribeProcessingJobInput(cr)
	resp, err := e.client.DescribeProcessingJobWithContext(ctx, input)
	if err != nil {
	...
	GenerateProcessingJob(resp).Status.AtProvider.DeepCopyInto(&cr.Status.AtProvider)
...
func (e *external) Create(ctx context.Context, mg cpresource.Managed) (managed.ExternalCreation, error) {
	...
	input := GenerateCreateProcessingJobInput(cr)
	resp, err := e.client.CreateProcessingJobWithContext(ctx, input)
	if err != nil {
