...
const (
	errUnexpectedObject = "managed resource is not an UserProfile resource"

	errCreateSession = "cannot create a new session"
	errCreate        = "cannot create UserProfile in AWS"
	errDescribe      = "failed to describe UserProfile"
	errDelete        = "failed to delete UserProfile"
)
...
func (c *connector) Connect(ctx context.Context, mg cpresource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*svcapitypes.UserProfile)
	if !ok {
...
func (e *external) Observe(ctx context.Context, mg cpresource.Managed) (managed.ExternalObservation, error) {
	...
	input := GenerateDescribeUserProfileInput(cr)
	resp, err := e.client.DescribeUserProfileWithContext(ctx, input)
	if err != nil {
	...
	GenerateUserProfile(resp).Status.AtProvider.DeepCopyInto(&cr.Status.AtProvider)
...
func (e *external) Create(ctx context.Context, mg cpresource.Managed) (managed.ExternalCreation, error) {
	...
	input := GenerateCreateUserProfileInput(cr)
	resp, err := e.client.CreateUserProfileWithContext(ctx, input)
	if err != nil {
...
func (e *external) Delete(ctx context.Context, mg cpresource.Managed) error {
	...
	input := GenerateDeleteUserProfileInput(cr)
	_, err := e.client.DeleteUserProfileWithContext(ctx, input)
