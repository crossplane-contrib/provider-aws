...
const (
	errUnexpectedObject = "managed resource is not an EndpointConfig resource"

	errCreateSession = "cannot create a new session"
	errCreate        = "cannot create EndpointConfig in AWS"
	errDescribe      = "failed to describe EndpointConfig"
	errDelete        = "failed to delete EndpointConfig"
)
...
func (c *connector) Connect(ctx context.Context, mg cpresource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*svcapitypes.EndpointConfig)
	if !ok {
...
func (e *external) Observe(ctx context.Context, mg cpresource.Managed) (managed.ExternalObservation, error) {
	...
	input := GenerateDescribeEndpointConfigInput(cr)
	resp, err := e.client.DescribeEndpointConfigWithContext(ctx, input)
	if err != nil {
	...
	GenerateEndpointConfig(resp).Status.AtProvider.DeepCopyInto(&cr.Status.AtProvider)
...
func (e *external) Create(ctx context.Context, mg cpresource.Managed) (managed.ExternalCreation, error) {
	...
	input := GenerateCreateEndpointConfigInput(cr)
	resp, err := e.client.CreateEndpointConfigWithContext(ctx, input)
	if err != nil {
...
func (e *external) Delete(ctx context.Context, mg cpresource.Managed) error {
	...
	input := GenerateDeleteEndpointConfigInput(cr)
	_, err := e.client.DeleteEndpointConfigWithContext(ctx, input)
