...
const (
	errUnexpectedObject = "managed resource is not an ModelPackage resource"

	errCreateSession = "cannot create a new session"
	errCreate        = "cannot create ModelPackage in AWS"
	errDescribe      = "failed to describe ModelPackage"
	errDelete        = "failed to delete ModelPackage"
)
...
func (c *connector) Connect(ctx context.Context, mg cpresource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*svcapitypes.ModelPackage)
	if !ok {
...
func (e *external) Observe(ctx context.Context, mg cpresource.Managed) (managed.ExternalObservation, error) {
	...
	input := GenerateDescribeModelPackageInput(cr)
	resp, err := e.client.DescribeModelPackageWithContext(ctx, input)
	if err != nil {
	...
	GenerateModelPackage(resp).Status.AtProvider.DeepCopyInto(&cr.Status.AtProvider)
...
func (e *external) Create(ctx context.Context, mg cpresource.Managed) (managed.ExternalCreation, error) {
	...
	input := GenerateCreateModelPackageInput(cr)
	resp, err := e.client.CreateModelPackageWithContext(ctx, input)
	if err != nil {
...
func (e *external) Delete(ctx context.Context, mg cpresource.Managed) error {
	...
	input := GenerateDeleteModelPackageInput(cr)
	_, err := e.client.DeleteModelPackageWithContext(ctx, input)
