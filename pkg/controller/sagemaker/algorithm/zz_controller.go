...
const (
	errUnexpectedObject = "managed resource is not an Algorithm resource"

	errCreateSession = "cannot create a new session"
	errCreate        = "cannot create Algorithm in AWS"
	errDescribe      = "failed to describe Algorithm"
	errDelete        = "failed to delete Algorithm"
)
...
func (c *connector) Connect(ctx context.Context, mg cpresource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*svcapitypes.Algorithm)
	if !ok {
...
func (e *external) Observe(ctx context.Context, mg cpresource.Managed) (managed.ExternalObservation, error) {
	...
	input := GenerateDescribeAlgorithmInput(cr)
	resp, err := e.client.DescribeAlgorithmWithContext(ctx, input)
	if err != nil {
	...
	GenerateAlgorithm(resp).Status.AtProvider.DeepCopyInto(&cr.Status.AtProvider)
...
func (e *external) Create(ctx context.Context, mg cpresource.Managed) (managed.ExternalCreation, error) {
	...
	input := GenerateCreateAlgorithmInput(cr)
	resp, err := e.client.CreateAlgorithmWithContext(ctx, input)
	if err != nil {
...
func (e *external) Delete(ctx context.Context, mg cpresource.Managed) error {
	...
	input := GenerateDeleteAlgorithmInput(cr)
	_, err := e.client.DeleteAlgorithmWithContext(ctx, input)
