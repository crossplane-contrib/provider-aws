...
func (c *connector) Connect(ctx context.Context, cr *svcapitypes.ResolverEndpoint) (managed.TypedExternalClient[*svcapitypes.ResolverEndpoint], error) {
...
func (e *external) Observe(ctx context.Context, cr *svcapitypes.ResolverEndpoint) (managed.ExternalObservation, error) {
...
func (e *external) Create(ctx context.Context, cr *svcapitypes.ResolverEndpoint) (managed.ExternalCreation, error) {
...
func (e *external) Update(ctx context.Context, cr *svcapitypes.ResolverEndpoint) (managed.ExternalUpdate, error) {
...
func (e *external) Delete(ctx context.Context, cr *svcapitypes.ResolverEndpoint) (managed.ExternalDelete, error) {
...
type external struct {
	...
	postDelete     func(context.Context, *svcapitypes.ResolverEndpoint, *svcsdk.DeleteResolverEndpointOutput, error) (managed.ExternalDelete, error)
...
func nopPostDelete(_ context.Context, _ *svcapitypes.ResolverEndpoint, _ *svcsdk.DeleteResolverEndpointOutput, err error) (managed.ExternalDelete, error) {
