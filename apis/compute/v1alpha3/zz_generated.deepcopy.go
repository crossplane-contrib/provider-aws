...
func (in *CustomSubnetIDReferencerForEKSCluster) DeepCopyInto(out *CustomSubnetIDReferencerForEKSCluster) {
	*out = *in
	out.SubnetIDReferencer = in.SubnetIDReferencer
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomSubnetIDReferencerForEKSCluster.
func (in *CustomSubnetIDReferencerForEKSCluster) DeepCopy() *CustomSubnetIDReferencerForEKSCluster {
	if in == nil {
		return nil
	}
	out := new(CustomSubnetIDReferencerForEKSCluster)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EKSClusterParameters) DeepCopyInto(out *EKSClusterParameters) {
	*out = *in
	if in.RoleARNRef != nil {
		...
		*out = new(IAMRoleARNReferencerForEKSCluster)
		**out = **in
	}
	if in.VPCIDRef != nil {
		in, out := &in.VPCIDRef, &out.VPCIDRef
		*out = new(VPCIDReferencerForEKSCluster)
		**out = **in
	}
	if in.SubnetIDs != nil {
	...
	if in.CustomSubnetIDs != nil {
		in, out := &in.CustomSubnetIDs, &out.CustomSubnetIDs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.CustomSubnetIDRefs != nil {
		in, out := &in.CustomSubnetIDRefs, &out.CustomSubnetIDRefs
		*out = make([]*CustomSubnetIDReferencerForEKSCluster, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(CustomSubnetIDReferencerForEKSCluster)
	...
	if in.SubnetIDRefs != nil {
		...
		*out = make([]*SubnetIDReferencerForEKSCluster, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(SubnetIDReferencerForEKSCluster)
				**out = **in
			}
		}
	}
	...
	if in.SecurityGroupIDRefs != nil {
		...
		*out = make([]*SecurityGroupIDReferencerForEKSCluster, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(SecurityGroupIDReferencerForEKSCluster)
				**out = **in
			}
		}
	}
...
func (in *SecurityGroupIDReferencerForEKSWorkerNodes) DeepCopy() *SecurityGroupIDReferencerForEKSWorkerNodes {
	...
	out := new(SecurityGroupIDReferencerForEKSWorkerNodes)
	in.DeepCopyInto(out)
	return out
}
