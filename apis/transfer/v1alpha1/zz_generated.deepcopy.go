...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomHomeDirectoryMapEntry) DeepCopyInto(out *CustomHomeDirectoryMapEntry) {
	*out = *in
	if in.Entry != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomHomeDirectoryMapEntry.
func (in *CustomHomeDirectoryMapEntry) DeepCopy() *CustomHomeDirectoryMapEntry {
	if in == nil {
		return nil
	}
	out := new(CustomHomeDirectoryMapEntry)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomServerObservation) DeepCopyInto(out *CustomServerObservation) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomServerObservation.
func (in *CustomServerObservation) DeepCopy() *CustomServerObservation {
	if in == nil {
		return nil
	}
	out := new(CustomServerObservation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CustomUserParameters) DeepCopyInto(out *CustomUserParameters) {
	*out = *in
	if in.HomeDirectoryMappings != nil {
		...
		*out = make([]*CustomHomeDirectoryMapEntry, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(CustomHomeDirectoryMapEntry)
...
func (in *DescribedAgreement) DeepCopyInto(out *DescribedAgreement) {
	*out = *in
	...
	if in.BaseDirectory != nil {
		in, out := &in.BaseDirectory, &out.BaseDirectory
		*out = new(string)
		**out = **in
	}
	if in.ServerID != nil {
...
func (in *DescribedConnector) DeepCopyInto(out *DescribedConnector) {
	*out = *in
	...
	if in.ServiceManagedEgressIPAddresses != nil {
		in, out := &in.ServiceManagedEgressIPAddresses, &out.ServiceManagedEgressIPAddresses
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
func (in *DescribedServer) DeepCopyInto(out *DescribedServer) {
	*out = *in
	...
	if in.As2ServiceManagedEgressIPAddresses != nil {
		in, out := &in.As2ServiceManagedEgressIPAddresses, &out.As2ServiceManagedEgressIPAddresses
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *S3StorageOptions) DeepCopyInto(out *S3StorageOptions) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new S3StorageOptions.
func (in *S3StorageOptions) DeepCopy() *S3StorageOptions {
	if in == nil {
		return nil
	}
	out := new(S3StorageOptions)
...
func (in *ServerObservation) DeepCopyInto(out *ServerObservation) {
	*out = *in
	...
	out.CustomServerObservation = in.CustomServerObservation
}
