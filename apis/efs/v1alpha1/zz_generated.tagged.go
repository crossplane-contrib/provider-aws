...
// AddTag adds a tag to this AccessPoint. If it already exists, it will be overwritten.
// It returns true if the tag has been added/changed. Otherwise false.
func (mg *AccessPoint) AddTag(key string, value string) bool {
	newTag := &Tag{
		Key:   &key,
		Value: &value,
	}
...
// AddTag adds a tag to this FileSystem. If it already exists, it will be overwritten.
// It returns true if the tag has been added/changed. Otherwise false.
func (mg *FileSystem) AddTag(key string, value string) bool {
	newTag := &Tag{
		Key:   &key,
		Value: &value,
	}
