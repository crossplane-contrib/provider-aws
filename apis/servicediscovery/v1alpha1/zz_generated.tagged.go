...
// AddTag adds a tag to this HTTPNamespace. If it already exists, it will be overwritten.
// It returns true if the tag has been added/changed. Otherwise false.
func (mg *HTTPNamespace) AddTag(key string, value string) bool {
	newTag := &Tag{
		Key:   &key,
		Value: &value,
	}
...
// AddTag adds a tag to this PrivateDNSNamespace. If it already exists, it will be overwritten.
// It returns true if the tag has been added/changed. Otherwise false.
func (mg *PrivateDNSNamespace) AddTag(key string, value string) bool {
	newTag := &Tag{
		Key:   &key,
		Value: &value,
	}
...
// AddTag adds a tag to this PublicDNSNamespace. If it already exists, it will be overwritten.
// It returns true if the tag has been added/changed. Otherwise false.
func (mg *PublicDNSNamespace) AddTag(key string, value string) bool {
	newTag := &Tag{
		Key:   &key,
		Value: &value,
	}
