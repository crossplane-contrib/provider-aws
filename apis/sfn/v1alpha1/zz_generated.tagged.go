...
// AddTag adds a tag to this Activity. If it already exists, it will be overwritten.
// It returns true if the tag has been added/changed. Otherwise false.
func (mg *Activity) AddTag(key string, value string) bool {
	newTag := &Tag{
		Key:   &key,
		Value: &value,
	}
...
// AddTag adds a tag to this StateMachine. If it already exists, it will be overwritten.
// It returns true if the tag has been added/changed. Otherwise false.
func (mg *StateMachine) AddTag(key string, value string) bool {
	newTag := &Tag{
		Key:   &key,
		Value: &value,
	}
