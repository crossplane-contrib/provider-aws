...
// AddTag adds a tag to this CertificateAuthority. If it already exists, it will be overwritten.
// It returns true if the tag has been added/changed. Otherwise false.
func (mg *CertificateAuthority) AddTag(key string, value string) bool {
	newTag := Tag{
		Key:   key,
		Value: value,
	}
