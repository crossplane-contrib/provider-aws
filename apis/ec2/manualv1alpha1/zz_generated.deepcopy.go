...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InstancesState) DeepCopyInto(out *InstancesState) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InstancesState.
func (in *InstancesState) DeepCopy() *InstancesState {
	if in == nil {
		return nil
	}
	out := new(InstancesState)
	in.DeepCopyInto(out)
	return out
}
