...
// AddTag adds a tag to this DBSubnetGroup. If it already exists, it will be overwritten.
// It returns true if the tag has been added/changed. Otherwise false.
func (mg *DBSubnetGroup) AddTag(key string, value string) bool {
	newTag := Tag{
		Key:   key,
		Value: value,
	}
...
// AddTag adds a tag to this RDSInstance. If it already exists, it will be overwritten.
// It returns true if the tag has been added/changed. Otherwise false.
func (mg *RDSInstance) AddTag(key string, value string) bool {
	newTag := Tag{
		Key:   key,
		Value: value,
	}
