...
func (mg *LifecyclePolicy) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	if err != nil {
		return errors.Wrap(err, "mg.Spec.ForProvider.CustomLifecyclePolicyParameters.RepositoryName")
	}
	mg.Spec.ForProvider.CustomLifecyclePolicyParameters.RepositoryName = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.ForProvider.CustomLifecyclePolicyParameters.RepositoryNameRef = rsp.ResolvedReference
