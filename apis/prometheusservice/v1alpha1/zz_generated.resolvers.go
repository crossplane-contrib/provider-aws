...
func (mg *RuleGroupsNamespace) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	if err != nil {
		return errors.Wrap(err, "mg.Spec.ForProvider.CustomRuleGroupsNamespaceParameters.WorkspaceID")
	}
	mg.Spec.ForProvider.CustomRuleGroupsNamespaceParameters.WorkspaceID = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.ForProvider.CustomRuleGroupsNamespaceParameters.WorkspaceIDRef = rsp.ResolvedReference
