...
func (in *AIMLOptionsInput) DeepCopyInto(out *AIMLOptionsInput) {
	*out = *in
	if in.NATuralLanguageQueryGenerationOptions != nil {
		...
		*out = new(NATuralLanguageQueryGenerationOptionsInput)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *AIMLOptionsOutput) DeepCopyInto(out *AIMLOptionsOutput) {
	*out = *in
	if in.NATuralLanguageQueryGenerationOptions != nil {
		in, out := &in.NATuralLanguageQueryGenerationOptions, &out.NATuralLanguageQueryGenerationOptions
		*out = new(NATuralLanguageQueryGenerationOptionsOutput)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *CancelledChangeProperty) DeepCopyInto(out *CancelledChangeProperty) {
	*out = *in
	if in.ActiveValue != nil {
		in, out := &in.ActiveValue, &out.ActiveValue
		*out = new(string)
		**out = **in
	}
	if in.CancelledValue != nil {
		in, out := &in.CancelledValue, &out.CancelledValue
		*out = new(string)
		**out = **in
	}
...
func (in *CancelledChangeProperty) DeepCopy() *CancelledChangeProperty {
	...
	out := new(CancelledChangeProperty)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ChangeProgressDetails) DeepCopyInto(out *ChangeProgressDetails) {
	*out = *in
	...
	if in.ConfigChangeStatus != nil {
		in, out := &in.ConfigChangeStatus, &out.ConfigChangeStatus
		*out = new(string)
		**out = **in
	}
...
func (in *DomainConfig) DeepCopyInto(out *DomainConfig) {
	*out = *in
	...
	if in.ModifyingProperties != nil {
		in, out := &in.ModifyingProperties, &out.ModifyingProperties
		*out = make([]*ModifyingProperties, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(ModifyingProperties)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
func (in *DomainMaintenanceDetails) DeepCopy() *DomainMaintenanceDetails {
	...
	out := new(DomainMaintenanceDetails)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DomainObservation) DeepCopyInto(out *DomainObservation) {
	*out = *in
	...
	if in.DomainProcessingStatus != nil {
		in, out := &in.DomainProcessingStatus, &out.DomainProcessingStatus
		*out = new(string)
		**out = **in
	}
	if in.EncryptionAtRestOptions != nil {
...
func (in *ModifyingProperties) DeepCopyInto(out *ModifyingProperties) {
	*out = *in
	...
	if in.PendingValue != nil {
		in, out := &in.PendingValue, &out.PendingValue
		*out = new(string)
		**out = **in
	}
	if in.ValueType != nil {
