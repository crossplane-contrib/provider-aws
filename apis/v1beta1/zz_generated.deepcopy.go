...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceURLConfig) DeepCopyInto(out *ServiceURLConfig) {
	*out = *in
	if in.URL != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceURLConfig.
func (in *ServiceURLConfig) DeepCopy() *ServiceURLConfig {
	if in == nil {
		return nil
	}
	out := new(ServiceURLConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *URLConfig) DeepCopyInto(out *URLConfig) {
	*out = *in
	...
	if in.Service != nil {
		...
		*out = make([]ServiceURLConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
