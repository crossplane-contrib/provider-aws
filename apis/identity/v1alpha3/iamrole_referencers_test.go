...
const (
	...
	mockIAMRoleName = "mockIAMRoleName"
)
...
func TestIAMRoleARNReferencerGetStatus(t *testing.T) {
	...
	for name, tc := range map[string]struct {
		...
		t.Run(name, func(t *testing.T) {
			r := IAMRoleARNReferencer{LocalObjectReference: corev1.LocalObjectReference{Name: mockName}}
...
func TestIAMRoleARNReferencerBuild(t *testing.T) {
...
func TestIAMRoleNameReferencerGetStatus(t *testing.T) {
	...
	for name, tc := range map[string]struct {
		...
		t.Run(name, func(t *testing.T) {
			r := IAMRoleNameReferencer{LocalObjectReference: corev1.LocalObjectReference{Name: mockName}}
...
func TestIAMRoleNameReferencerBuild(t *testing.T) {
