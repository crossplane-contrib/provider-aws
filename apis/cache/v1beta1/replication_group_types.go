...
type ReplicationGroupParameters struct {
	...
	//
	// Important: writeConnectionSecretToRef must be set when using authTokenSecretRef.
	// The controller compares the current password stored in the connection secret with
	// the desired password from authTokenSecretRef to detect changes. Without
	// writeConnectionSecretToRef, password change detection is disabled.
	//
