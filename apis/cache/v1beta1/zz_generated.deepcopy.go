...
func (in *DestinationDetails) DeepCopyInto(out *DestinationDetails) {
	*out = *in
	if in.CloudWatchLogsDetails != nil {
		in, out := &in.CloudWatchLogsDetails, &out.CloudWatchLogsDetails
		*out = new(CloudWatchLogsDestinationDetails)
		(*in).DeepCopyInto(*out)
	}
	if in.KinesisFirehoseDetails != nil {
		in, out := &in.KinesisFirehoseDetails, &out.KinesisFirehoseDetails
...
func (in *LogDeliveryConfiguration) DeepCopyInto(out *LogDeliveryConfiguration) {
	*out = *in
	if in.EngineLogs != nil {
		in, out := &in.EngineLogs, &out.EngineLogs
		*out = new(LogsConf)
		(*in).DeepCopyInto(*out)
	}
	if in.SlowLogs != nil {
		in, out := &in.SlowLogs, &out.SlowLogs
		*out = new(LogsConf)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LogsConf) DeepCopyInto(out *LogsConf) {
	*out = *in
	if in.DestinationDetails != nil {
		in, out := &in.DestinationDetails, &out.DestinationDetails
		*out = new(DestinationDetails)
		(*in).DeepCopyInto(*out)
	}
	if in.Enabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LogsConf.
func (in *LogsConf) DeepCopy() *LogsConf {
	if in == nil {
		return nil
	}
	out := new(LogsConf)
...
func (in *NodeGroup) DeepCopyInto(out *NodeGroup) {
	*out = *in
	...
	out.ReaderEndpoint = in.ReaderEndpoint
}
...
func (in *ReplicationGroupParameters) DeepCopyInto(out *ReplicationGroupParameters) {
	*out = *in
	...
	in.LogDeliveryConfiguration.DeepCopyInto(&out.LogDeliveryConfiguration)
