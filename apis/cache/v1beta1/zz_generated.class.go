...
func (cs *ReplicationGroupClass) GetReclaimPolicy() runtimev1alpha1.ReclaimPolicy {
	return cs.SpecTemplate.ReclaimPolicy
}

// SetReclaimPolicy of this ReplicationGroupClass.
func (cs *ReplicationGroupClass) SetReclaimPolicy(r runtimev1alpha1.ReclaimPolicy) {
