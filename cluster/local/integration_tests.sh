...
"${UP}" alpha xpkg xp-extract --from-xpkg "${XPKG_OUTPUT_DIR}"/"${PLATFORM}"/"${PACKAGE_NAME}"-"${VERSION}".xpkg -o "${CACHE_PATH}/${PACKAGE_NAME}.gz" && chmod 644 "${CACHE_PATH}/${PACKAGE_NAME}.gz"
